...
class Nocturnist : PlayerPawn
{
    Default
	{
		...
		Mass 100;
		PainChance 255;
		Player.DisplayName "Nocturnist";
		Player.CrouchSprite "PLYC";
		Player.StartItem "Pistol";
		Player.StartItem "TestFist";
		Player.StartItem "Clip", 50;
		Player.WeaponSlot 1, "TestFist", "Chainsaw";
		Player.WeaponSlot 2, "Pistol";
		Player.WeaponSlot 3, "TestShotgun", "SuperShotgun";
		Player.WeaponSlot 4, "Chaingun";
		Player.WeaponSlot 5, "TestRocketLauncher";
